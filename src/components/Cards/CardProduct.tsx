    ...
    <Link href={`/product/${slug}`} className="group">
      <div className="max-w-60 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 m-1 lg:m-3 group-hover:-translate-y-2 group-hover:shadow-none transition-all duration-500 overflow-hidden">
        <div className="overflow-hidden ">
          <img
            className="rounded-t-lg aspect-square object-cover object-center group-hover:scale-110 transition-all duration-500"
            src={imageUrl}
            alt=""
          />
        </div>
        <div className="md:px-5 px-1 md:py-2 py-1 bg-gray-50 group-hover:bg-white">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex items-center">
              <svg
                className="lg:w-3 lg:h-3 w-2 text-yellow-500 md:ms-1"
                aria-hidden="true"
